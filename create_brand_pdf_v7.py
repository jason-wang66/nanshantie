...
# -*- coding: utf-8 -*-
"""
南山帖品牌手册PDF - 第四版（修复图片问题）
1. 产品图：先center crop为正方形，再压缩到统一宽度
2. 水墨图：只叠加朱红方印，不叠加山客名大字（因为AI生成图已自带）
3. 产品图：保留茶品名+季节+朱红方印
"""
...
PREVIEW_DIR = "./白茶品牌/preview/brand_manual_v4"
...
def create_brand_manual_v4():
    """创建第四版品牌手册"""
    print("开始创建南山帖品牌手册第四版（修复图片问题）...")
